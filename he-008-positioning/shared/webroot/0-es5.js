(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[0], {
    ...
    /***/
    function np3L(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "C", function () {
        return formatDateAsDayString;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "D", function () {
        return truncateStringPortion;
      });
      /* harmony export (binding) */
      ...
      var stencilSubscription = function stencilSubscription(_ref) {
        var on = _ref.on;
        ...
        if (typeof _index_267cdec7_js__WEBPACK_IMPORTED_MODULE_0__["g"] === 'function') {
          ...
          on('get', function (propName) {
            var elm = Object(_index_267cdec7_js__WEBPACK_IMPORTED_MODULE_0__["g"])();
          ...
          on('reset', function () {
            elmsToUpdate.forEach(function (elms) {
              return elms.forEach(_index_267cdec7_js__WEBPACK_IMPORTED_MODULE_0__["f"]);
            });
            cleanupElements(elmsToUpdate);
          });
        }
      ...
      var createObservableMap = function createObservableMap(defaultState) {
        ...
        var state = typeof Proxy === 'undefined' ? {} : new Proxy(defaultState, {
        ...
        var onChange = function onChange(propName, cb) {
          ...
          var unReset = on('reset', function () {
            return cb(defaultState[propName]);
          });
          return function () {
            unSet();
            unReset();
      ...
      var _createStore = createStore({
        ...
        isStateSet: false
          ...
          state = _createStore.state,
          onChange = _createStore.onChange; // Needed when text is not directly translated in the dom
      ...
      function _setLocale() {
        _setLocale = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 2:
                  ...
                  return _context2.abrupt("return", Promise.all([getLanguage(), getDateFormat(), getTimeFormat()]).then( /*#__PURE__*/function () {
                    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref2) {
                      var _ref4, language, dateFormat, timeFormat;

                      return regeneratorRuntime.wrap(function _callee$(_context) {
                        while (1) {
                          switch (_context.prev = _context.next) {
                            case 0:
                              _ref4 = _slicedToArray(_ref2, 3), language = _ref4[0], dateFormat = _ref4[1], timeFormat = _ref4[2];
      ...
      function _getLanguage() {
        _getLanguage = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
          var language;
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  _context3.prev = 2;
                  _context3.next = 5;
                  return getPortalContext().getSCSUserSetting('bci.system.language');
      ...
      function _getDateFormat() {
        _getDateFormat = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  return _context4.abrupt("return", DEFAULT_LOCALE.dateFormat);

                case 2:
                  _context4.prev = 2;
                  _context4.next = 5;
                  return getPortalContext().getSCSUserSetting('bci.system.dateformat');
      ...
      function getTimeFormat() {
        return _getTimeFormat.apply(this, arguments);
      }

      function _getTimeFormat() {
        _getTimeFormat = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
            ...
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  ...
                  return _context5.abrupt("return", DEFAULT_LOCALE.timeFormat);

                case 2:
                  _context5.prev = 2;
                  _context5.next = 5;
                  return getPortalContext().getSCSUserSetting('bci.system.timeformat');
      ...
      function setupLangChangeListener() {
        ...
        var observer = new MutationObserver(function (mutations) {
          ...
          if (mutations.filter(function (item) {
            return item.attributeName === 'lang';
          }).length > 0) {
      ...
      function formatDateAsDayString(timestamp) {
        var dateFormat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_LOCALE.dateFormat;
      ...
      function truncateStringPortion(str) {
        ...
        var halfTheLength = Math.floor((maxLength - dotCount) / 2);
        var convertedStr = '';
      ...
      function createDate(dateInstance, year, month) {
      ...
      function createTime(dateInstance, hours, minutes) {
